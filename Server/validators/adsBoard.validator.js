...
export const createAdsBoardValidation = [
  ...
  body('adsboard_type').optional().isMongoId().withMessage('Adsboard type is required and must be a valid ObjectId'),
  ...
  body('contract_start_date').isISO8601().toDate().optional().withMessage('Contract start date is required and must be a valid date in ISO8601 format'),
  body('contract_end_date').isISO8601().toDate().optional().withMessage('Contract end date is required and must be a valid date in ISO8601 format'),
