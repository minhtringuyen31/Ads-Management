...
export const createAdsBoardValidation = [
  ...
  body('contract_start_date').toDate().withMessage('Contract start date is required and must be a valid date in ISO8601 format'),
  body('contract_end_date').toDate().withMessage('Contract end date is required and must be a valid date in ISO8601 format'),
...
export const updateAdsBoardValidation = [
  ...
  body('contract_start_date').toDate().optional().withMessage('Contract start date must be a valid date in ISO8601 format'),
  body('contract_end_date').toDate().optional().withMessage('Contract end date must be a valid date in ISO8601 format'),
